 ...
 * The function is fully unrolled to add round constants w/ immediate values.
 */
@ void 	tks_perm_23_norc(uint32_t *rtk)
.global tks_perm_23_norc
.type   tks_perm_23_norc,%function
.align	2
tks_perm_23_norc:
	push 		{r0-r12, lr}
	sub.w 		sp, #4 						//to store r14 in subroutines
 ...
 */
@ void 	tks_perm_1(u32* tk, const u8* key)
.global tks_perm_1
