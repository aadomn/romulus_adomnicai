...
/*
 * Computes LFSR3(TK3) for all rounds.
 * Useful for masking since the secret key is passed as TK3 only.
 */
@ void 	tks_lfsr_3(uint32_t* tk, const uint8_t* tk3, const int rounds)
.global tks_lfsr_3
.type   tks_lfsr_3,%function
.align	2
tks_lfsr_3:
	push 	{r0-r12, r14}
	// load 128-bit tk3
	...
	// load loop counter (#rounds) in r1
	ldr.w 	r1, [sp, #8]
	// store tk3 in round tweakeys array (r0)
	str.w 	r3, [r0, #4]
	str.w 	r4, [r0, #8]
	str.w 	r5, [r0, #12]
	str.w 	r2, [r0], #16
